package com.noman.example.spark
...
object GraphX {
  ...
  def main(args: Array[String]) {
    ...
    val names = sc.textFile("/home/noman/sparkStreamingResources/SparkScala/Marvel-names.txt")
    val verts = names.flatMap(parseNames)
    
    // Build up our edges
    val lines = sc.textFile("/home/noman/sparkStreamingResources/SparkScala/Marvel-graph.txt")
